...
import { License, Payment } from "@/types/table.type";
...
export const columns: ColumnDef<Payment>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("project_domain")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="lowercase">{row.getValue("last_accessed")}</div>
    ),
  },
  {
